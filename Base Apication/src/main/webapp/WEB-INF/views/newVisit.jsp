                ...
                <div class="col">
                    <div class="form-group row">
                        ...
                        <label for="visitDate" class="col-6 col-form-label">
                            <b>Fecha de visita</b>
                            <form:input class="form-control" type="date" value="2011-08-19" id="date" path="date">
                            </form:input>
                        </label>
                    </div>
                    <div class="form-group">
                        <label for="description col-12"><b>Motivo de visita</b></label>
                        <form:textarea class="form-control col-12" id="description" rows="3" path="description">
                        </form:textarea>
                    </div>
