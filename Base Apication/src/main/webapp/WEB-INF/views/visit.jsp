...
<body>
	...
	<div class="container col-4 bg-white"
		...
		<h3>
			...
			<spring:message code="visit.requestVisit" />
		</h3>
		...
		<form:form modelAttribute="visit" style="margin-top: 3%;" id="visit"
			...
			<div class="row">
				<div class="col-6">
					...
					<label for="doctor" class="col-form-label"><b>Doctor</b></label> <select
						id="doctor" class="form-control" name="doctorDni"
						<sec:authorize access="hasAnyRole('ROLE_EMPLOYEE')" > readonly</sec:authorize>>
				...
				<div class="col-6">
					<label for="visitDate" class="col-form-label"><b><spring:message
								code="visit.date" /></b> </label>
			...
			<div class="form-group">
				<label for="description" class="col-form-label"><b><spring:message
							code="visit.motive" /></b></label>
			...
			<sec:authorize access="hasAnyRole('ROLE_EMPLOYEE')">
				...
				<input type="text" value="${patientDni}" id="" name="patientDni"
					hidden="" />
				<div class="form-group">
					<label for="description col-12"><b><spring:message
								code="visit.resolution" /></b></label>
			...
			<div class="d-flex justify-content-center">
				<sec:authorize access="hasAnyRole('ROLE_EMPLOYEE')">
					<button type="submit" class="btn btn-outline-success">
						<spring:message code="visit.modify" />
					</button>
				</sec:authorize>
				<sec:authorize access="hasAnyRole('ROLE_PATIENT')">
					<button type="submit" class="btn btn-outline-success">
						<spring:message code="visit.request" />
					</button>
				</sec:authorize>
			</div>
		</form:form>
